...
const PersonalTaskStats = async() => {
   ...
   return (
      <div>
         ...
         <PersonalTasksStatusChart data={filteredData} title={"Personal Tasks Status"} />
         <PersonalTasksStatusAmountChart data={filteredData} title={"Personal Tasks Status Amount"} />
         <PersonalTasksPriorityChart data={filteredData} title={"Personal Tasks Priority"} />
         <PersonalTaskPriorityAmountChart data={filteredData} title={"Personal Tasks Priority Amount"} />
         </div>
         :
         <div className="flex flex-col items-center justify-center">
         <div className="text-center">Oopsi daisy! Seems like you are free of obligations!</div>
         <Link href="/tasks" className="text-center mt-2 hover:underline focus:underline transitions-all duration-200">
            Create your first personal task, so you can join procrastination!</Link>
         </div>
         }
